...
//configWPI_Revs.setReversed(true);
    ...
    public static Trajectory exampleTrajectoryWPI_E = edu.wpi.first.math.trajectory.TrajectoryGenerator.generateTrajectory(
            ...
            new edu.wpi.first.math.geometry.Pose2d(1.7, 0,
                    new edu.wpi.first.math.geometry.Rotation2d(0)),
//            Arrays.asList(
//                    new edu.wpi.first.math.geometry.Translation2d(1.7, -0.1),//1),
//                    new edu.wpi.first.math.geometry.Translation2d(1.7, -0.2)//-1)
//            ),
...
//            ),
    ...
    public static Trajectory Trajectory_GotoA = edu.wpi.first.math.trajectory.TrajectoryGenerator.generateTrajectory(
        new edu.wpi.first.math.geometry.Pose2d(0, 0,
                new edu.wpi.first.math.geometry.Rotation2d(0)),
        Arrays.asList(
    ...
    public static Trajectory Trajectory_GotoB = edu.wpi.first.math.trajectory.TrajectoryGenerator.generateTrajectory(
    ...
    public static Trajectory Trajectory_PushB = edu.wpi.first.math.trajectory.TrajectoryGenerator.generateTrajectory(
        Arrays.asList(
            new edu.wpi.first.math.geometry.Pose2d(1.4, -1.05,
                    new edu.wpi.first.math.geometry.Rotation2d(Units.degreesToRadians(0))),
            new edu.wpi.first.math.geometry.Pose2d(0, -1.05,
    ...
    public static Trajectory Trajectory_GotoC = edu.wpi.first.math.trajectory.TrajectoryGenerator.generateTrajectory(
        new edu.wpi.first.math.geometry.Pose2d(0, -1.05,
                new edu.wpi.first.math.geometry.Rotation2d(0)),
        Arrays.asList(
    ...
    public static Trajectory Trajectory_PushC = edu.wpi.first.math.trajectory.TrajectoryGenerator.generateTrajectory(
        Arrays.asList(
            new edu.wpi.first.math.geometry.Pose2d(1.4, -1.25,
                    new edu.wpi.first.math.geometry.Rotation2d(Units.degreesToRadians(0))),
