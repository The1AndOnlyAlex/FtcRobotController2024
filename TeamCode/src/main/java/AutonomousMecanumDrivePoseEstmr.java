...
@Autonomous
public class AutonomousMecanumDrivePoseEstmr extends CommandOpMode {

    private Motor frontLeft, frontRight, backLeft, backRight;
    GyroEx gyro;
//    private MecanumDriveSubsystem mecanumDriveSubsystem;
    private WpiMecanumDriveSubsystem wpiMecanumDriveSubsystem;
...
//        backRight.setBuffer(1);
	...
	frontLeft.setZeroPowerBehavior(Motor.ZeroPowerBehavior.BRAKE);
        ...
        wpiMecanumDriveSubsystem = new WpiMecanumDriveSubsystem(
                frontLeft,
                frontRight,
                backLeft,
                backRight,
                DriveConstants.kinematicsWPI,
                gyro,
                aprilTag,
        ...
        wpiMecanumDriveSubsystem.enableDrive();
...
//                new ApriltagCommand(wpiMecanumDriveSubsystem, aprilTag, telemetry));
        ...
        //schedule(new RunCommand(telemetry::update));
            ...
            schedule(new AutoSequentialCommand(
                    wpiMecanumDriveSubsystem,
                    intakeSubsystem,
